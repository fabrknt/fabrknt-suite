...
export default function SellerDashboardPage() {
    ...
    const underOffer = myListings.filter(
        (l) => l.status === "under_offer"
    ).length;
        ...
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-muted-foreground mt-2">
                    Manage your project listings and track buyer interest — all
                    inquiries are private and confidential.
                </p>
            </div>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-amber-800">
                            This dashboard displays sample listings for
                            demonstration purposes. In production, you will see
                            only your own listings based on your connected
                            wallet address. All data shown is fictional and for
                            preview only.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground/75">
                                        For "
                                        {myListings[1]?.projectName ||
                                            myListings[0].projectName}
                                        "
                                    </p>
                                </div>
                                <span className="text-xs text-muted-foreground/75">
