        ...
        return {
            ...
            scores: {
                ...
                breakdown: {
                    ...
                    wallet: {
                        distributionScore: Math.min(company.walletQualityScore, 100),
                        smartMoneyScore: Math.min(company.walletQualityScore * 0.8, 100),
                    },
                    social: {
            ...
            <div className="p-8 space-y-8">
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                    ...
                    <div className="text-sm text-purple-800 space-y-2">
                        ...
                        <p>
                            <strong>No Manual Input:</strong> Index
                        ...
                        <p>
                            ...
                            daily to provide the most current index on
